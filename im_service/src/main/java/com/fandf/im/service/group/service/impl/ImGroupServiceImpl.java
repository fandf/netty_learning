package com.fandf.im.service.group.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.fandf.im.common.ResponseVO;
import com.fandf.im.common.enums.GroupErrorCode;
import com.fandf.im.common.enums.GroupMemberRoleEnum;
import com.fandf.im.common.enums.GroupStatusEnum;
import com.fandf.im.common.enums.GroupTypeEnum;
import com.fandf.im.common.exception.ApplicationException;
import com.fandf.im.service.group.dao.ImGroupMapper;
import com.fandf.im.service.group.model.entity.ImGroupEntity;
import com.fandf.im.service.group.model.req.*;
import com.fandf.im.service.group.model.resp.GetGroupResp;
import com.fandf.im.service.group.model.resp.GetJoinedGroupResp;
...
public class ImGroupServiceImpl implements ImGroupService {
    ...
    public ResponseVO importGroup(ImportGroupReq req) {
        ...
        if (StringUtils.isEmpty(req.getGroupId())) {
            ...
            if (imGroupDataMapper.exists(query)) {
        ...
        if (imGroupEntity.getCreateTime() == null) {
