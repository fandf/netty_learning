package com.fandf.im.service.friendship.dao;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.fandf.im.service.friendship.model.entity.ImFriendShipEntity;
import com.fandf.im.service.friendship.model.req.CheckFriendShipReq;
...
public interface ImFriendShipMapper extends BaseMapper<ImFriendShipEntity> {
     ...
     */
    @Select("<script>" +
            "select from_id as fromId , to_id as toId ,if(status = 1,1,0) as status from im_friendship " +
